...
public class LoginVerticle extends AbstractVerticle{
    ...
    public void handleLogin(Message<Object> handler){
        ...
        LocalMap<String,String> IPMap = vertx.sharedData().getLocalMap(Key.IP_MAP);   //token->IP
        ...
        //登录
        String userId = paramJson.containsKey("userName")?paramJson.getValue("userName").toString():"";        //帐号
